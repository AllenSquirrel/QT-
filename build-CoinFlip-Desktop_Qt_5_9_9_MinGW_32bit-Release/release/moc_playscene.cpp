...
QT_MOC_LITERAL(1, 10, 13), // "playSceneBack"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "PlayScene\0playSceneBack\0"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PlayScene *_t = static_cast<PlayScene *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (PlayScene::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::playSceneBack)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PlayScene::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_PlayScene.data,
      qt_meta_data_PlayScene,  qt_static_metacall, nullptr, nullptr}
};
